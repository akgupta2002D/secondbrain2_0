...
Read this first. It is a snapshot of **what the app actually is today** (version `0.0.32` in `vite.config.ts`) and **why**, so you can change it without rediscovering product rules.
